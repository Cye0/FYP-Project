...
def test(image, model_dir, device_id):
    ...
    for model_name in os.listdir(model_dir):
        if not model_name.endswith('.pth'):
            continue  # skip .DS_Store or other junk files
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_name",
        type=str,
        default="/Users/calebyeo/Downloads/4. Degree 3/Project/Dataset/Casia-fasd/test_img/RGB_Images/org_1_80x80/train/1/1_1.avi_50_real.jpg",
